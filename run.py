...
if __name__ == '__main__':
    ...
    import logging
    logging.basicConfig(filename='prosphero.log', level=logging.DEBUG, format='%(message)s')
    logging.info('\n' + str(datetime.datetime.utcnow()) + ' Program started by ' + getpass.getuser() +
    ...
    CC_schema.insert_current_price()
